...
class QuanvNNTrainer:
    ...
    def set_preprocessed_datasets(self):
        ...
        is_processed_data_filename_given = self.processed_data_filename is not None
        processed_data_save_flag = is_processed_data_filename_given
        ...
        if processed_data_save_flag:
            ...
            train_output_path = os.path.join(
                self.model_output_dir, "train_" + self.processed_data_filename
            )
        ...
        if processed_data_save_flag:
            ...
            test_output_path = os.path.join(
                self.model_output_dir, "test_" + self.processed_data_filename
            )
